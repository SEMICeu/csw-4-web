...
*/    
    ...
    if (in_array($result_http_code, array('300','404','415'))) {
      ...
      if (is_array($result_headers["Content-Type"])) {
        header("Content-Type: " . $result_headers["Content-Type"][count($result_headers["Content-Type"])-1]);
      } else {
