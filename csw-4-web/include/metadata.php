...
// Style on geodcat-ap.semic.eu
  ...
  $head .= '<link rel="stylesheet" type="text/css" href="./api/css/style.css"/>' . "\n";

  $footer = '';
  $footer .= '<p>';
  $footer .= ' <a href="https://joinup.ec.europa.eu/community/are3na/" target="_blank"><img alt="ARe3NA" src="./css/isa-are3na-logo.jpg" height="70"></a> ';
